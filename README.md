A simple web application that allows users to search Wikipedia using a keyword. The application fetches data from a Wikipedia API and displays the results dynamically on the webpage.
